...
function Write-AiHandoff {
    ...
    # The copy-paste block is intentionally the LAST thing printed, so it sits at
    # the very bottom of the console and needs no scrolling to see & copy.
    Write-Host ''
...
# Printed last: the copy-paste block must be the final thing on screen so it is
# visible and copyable without scrolling up.
